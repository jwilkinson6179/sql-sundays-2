...
SELECT Start_Date, Finished
FROM (
    SELECT first.Start_Date, Min(second.End_Date) As Finished
    FROM
        (SELECT Start_Date
        FROM Projects
        ...
        FROM Projects)) second
    WHERE Start_Date < End_Date
    GROUP BY first.Start_Date) proj
ORDER BY DATEDIFF(Finished, Start_Date), Start_Date;